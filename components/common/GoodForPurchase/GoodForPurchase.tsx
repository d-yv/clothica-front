          ...
          <div className={css.container}>
              <div className={css.col}>
                  <div className={css.imageWrap}>
                     ...
                     <div className={css.col}>
                      <nav className={css.menuList}>
                        ...
                        <svg width="5" height="8" className={css.right}> <use href="/styles.icon.svg#icon-Chevron-Right" /></svg>
                        <Link href={{
                                  pathname: "/goods",
                                  query: { categoryName: good.categoryName },
                                  }} className={css.menuLink}>Категорія</Link>
                        <svg width="5" height="8" className={css.right}> <use href="/styles.icon.svg#icon-Chevron-Right" /></svg>
                    ...
                    >
                      <use href="/styles.icon.svg#icon-Star-Filled-2" />
                        ...
                        <span className={css.feedback}>• {good.feedbackCount ?? 0} відгуків</span>
                      </div>
                  </div>
                  ...
                  <div className={css.sizeSelector}>
                    ...
                    <svg className="selectIcon"><use href="/styles.icon.svg#icon-Chevron-Down" /></svg>
                    </select>
                  </div>
                  
                  <div className={css.buttonGroup}>
                    <button className={css.btn1}>Додати в кошик</button>
                    <button className={css.quantityValue}>1</button>
                  </div>
